...
| **Rust** | `cargo add kuttidb@0.1.0` | [Rust crate](clients/rust) |
| **Java** | Maven: `io.github.kuttidb:kuttidb-client:0.1.2` | [Java client](clients/java) |
...
```kotlin
implementation("io.github.kuttidb:kuttidb-client:0.1.2")
```
